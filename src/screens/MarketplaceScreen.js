  ...
  useEffect(() => {
    async function restoreCart() {
      ...
      try {
        ...
        setStorageError('Could not load your saved cart.')
      } finally {
        setIsLoading(false)
      }
    }
          ...
          ListHeaderComponent={
            <View style={styles.listHeader}>
              ...
              <Text style={styles.subheading}>
                A clean, current marketplace layout with compact product rows
                and fast cart actions.
              </Text>
            </View>
          }
        />
          ...
          {cartItems.length === 0 ? (
            <View style={styles.emptyCard}>
              ...
              <Text style={styles.emptyText}>
                Add a product from the Shop tab, then refresh the app to prove
                persistence works.
              </Text>
            </View>
          ) : (
